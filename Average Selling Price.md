...
```
 ...
 الdata type بتاع الاعمدة هي INTEGER ف لو جينا نشتغل عليها هيطلع النواتج ارقام صحيحة مع ان الحل المطلوب عبارة عن ارقام عشرية.
 لازم نعمل (::numeric لو شغالين postgresql) (او cast(...) as decimal لو شغالين sql server)
كدا هنحول الاعمدة دي ل numeric عشان الارقام العشرية تظهر في الناتج
